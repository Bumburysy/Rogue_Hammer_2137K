...
public class OrcEnemy extends Enemy {
    ...
    private static final float COLLISION_WIDTH_MULTIPLIER = 1.0f;
    private static final float COLLISION_HEIGHT_MULTIPLIER = 1.0f;
    private static final int ORC_MAX_HEALTH = 10;
